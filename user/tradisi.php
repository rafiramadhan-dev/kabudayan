...
require_once '../database/koneksi.php';
    ...
    $kategori = isset($_GET['kategori']) ? $_GET['kategori'] : 'Rumah Adat';
...
<head>
    ...
    <title>Kebudayaan - Tradisi</title>
...
<body>
    ...
    <section class="hero">
        <img src="../assets/img/tradisi.png" alt="Tradisi Jawa Tengah">
    </section>

    <div class="container">
        <aside class="sidebar">
            <ul>
                <li><a href="tradisi.php?kategori=Rumah Adat" class="<?php echo ($kategori == 'Rumah Adat') ? 'active' : ''; ?>">Rumah Adat</a></li>
                <li><a href="tradisi.php?kategori=Pakaian Adat" class="<?php echo ($kategori == 'Pakaian Adat') ? 'active' : ''; ?>">Pakaian Adat</a></li>
                <li><a href="tradisi.php?kategori=Destinasi" class="<?php echo ($kategori == 'Destinasi') ? 'active' : ''; ?>">Destinasi</a></li>
            </ul>
        </aside>
