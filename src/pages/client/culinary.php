...
$kategori = isset($_GET['kategori']) ? $_GET['kategori'] : 'Minuman Khas';
...
<head>
    ...
    <title>Kebudayaan - Kuliner</title>
...
<body>
    ...
    <section class="hero">
        <img src="../assets/img/kuliner.png" alt="Kuliner Jawa Tengah">
    </section>

    <div class="container">
        <aside class="sidebar">
            <ul>
                <li><a href="kuliner.php?kategori=Minuman Khas" class="<?php echo ($kategori == 'Minuman Khas') ? 'active' : ''; ?>">Minuman Khas</a></li>
                <li><a href="kuliner.php?kategori=Makanan Khas" class="<?php echo ($kategori == 'Makanan Khas') ? 'active' : ''; ?>">Makanan Khas</a></li>
            </ul>
        </aside>
